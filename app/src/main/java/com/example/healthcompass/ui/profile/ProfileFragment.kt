...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val manageProfileInfo = ManageProfileInfoFragment()
        val achievements = ManageProfileInfoFragment()
        val notifications = NotificationsFragment()
        val friends = FriendsFragment()
        val changePassword = ChangePasswordFragment()

        binding.arrManageProfileInfo.setOnClickListener{ replaceFragment(manageProfileInfo) }
        binding.arrAchievements.setOnClickListener{ replaceFragment(achievements) }
        binding.arrNotifications.setOnClickListener{ replaceFragment(notifications) }
        binding.arrFriends.setOnClickListener{ replaceFragment(friends) }
        binding.arrChangePassword.setOnClickListener{ replaceFragment(changePassword) }
