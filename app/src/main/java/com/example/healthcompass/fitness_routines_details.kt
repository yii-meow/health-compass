 ...
 * Use the [fitness_routines_details.newInstance] factory method to
...
class fitness_routines_details : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment fitness_routines_details.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            fitness_routines_details().apply {
